...
public class PlayerSQLStatements {
     ...
     */
    protected static final String INSERT_NEW_PLAYER  = "INSERT INTO PlayerInfo VALUES (?, ?, ?) ON DUPLICATE KEY UPDATE recentName = VALUES(recentName), recentAddress = VALUES(recentAddress);";
